...
/**
  ...
  /**
   * `prisma.tableAgent`: Exposes CRUD operations for the **TableAgent** model.
    * Example usage:
    * ```ts
    * // Fetch zero or more TableAgents
    * const tableAgents = await prisma.tableAgent.findMany()
    * ```
    */
  get tableAgent(): Prisma.TableAgentDelegate<ExtArgs, { omit: OmitOpts }>;
